...
void ETH_GPIO_Config(void)
{
  ...
  GPIO_Init(GPIOA, &GPIO_InitStructure);              
	...
	//MII/RMII�ӿ�ѡ��
#ifdef MII_MODE              //ѡ��MIIģʽ
 #ifdef PHY_CLOCK_MCO       //ʱ���ź���MCO��������ṩ
 
  RCC_MCO1Config(RCC_MCO1Source_HSE, RCC_MCO1Div_1); //��PA8���������25MHZ��ʱ���ź�
 #endif /* PHY_CLOCK_MCO */

  SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_MII);  //��PHYоƬͨѶѡ��MIIģʽ
	
#elif defined RMII_MODE  //ѡ��RMII�ӿ�ģʽ��PHYоƬ����ͨѶ 

  RCC_MCO1Config(RCC_MCO1Source_PLLCLK,RCC_MCO1Div_2); //��PA8���������50MHZʱ���ź�

  SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_RMII); //��PHYоƬͨѶѡ��RMIIģʽ
#endif
